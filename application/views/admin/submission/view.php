<div class="col-md-12">
    <div class="bd-example loginpage mb-3">
        <div role="alert">
            ...
            <hr>
            <p class="list-item-heading">Name - <?php echo $user_submission['name']; ?></p>
            <p class="list-item-heading mb-4">Email - <a href="mailto:<?php echo $user_submission['email']; ?>"><?php echo $user_submission['email']; ?></a></p>
            <hr>
            <div class="card">
                <div class="card-body">
                                        ...
                                        <?php if(!empty($step['questions'])) { ?>
                                            <?php foreach ($step['questions'] as $key => $question) { ?>
                                                ...
                                                <div class="alert alert-<?php echo $class; ?> p-4 mt-4 mb-0">
                                                    ...
                                                    <?php } ?>
                                                    <hr class="my-2">
                                                    <p class="mb-1">Their answer: <?php echo ($view_answer) ? $view_answer : '-- NA --'; ?></p>
